...
public class ClassLoaderUtils {
    ...
    static {
        try {
            ...
            FIND_LOADED_CLASS_METHOD = ClassLoader.class.getDeclaredMethod("findLoadedClass", new Class[] { String.class });
    ...
    public static Class<?> findLoadedClass(String className, ClassLoader cl) 
    {
            ...
            try
            {
                c = (Class<?>) FIND_LOADED_CLASS_METHOD.invoke(cl,className);
            }
