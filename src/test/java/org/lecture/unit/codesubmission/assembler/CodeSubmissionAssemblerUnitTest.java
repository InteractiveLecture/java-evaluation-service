package org.lecture.unit.codesubmission.assembler;
...
@ContextConfiguration(classes = {CodeSubmissionAssemblerUnitTestConfig.class})
@WebAppConfiguration
public class CodeSubmissionAssemblerUnitTest {
